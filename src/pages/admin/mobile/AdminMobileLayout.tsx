  ...
  return <div className="min-h-[100dvh] bg-[#f4f6f8] pb-20 text-slate-900">
    ...
    <nav className="fixed inset-x-0 bottom-0 z-30 border-t border-slate-200 bg-white/95 pb-[max(0.45rem,env(safe-area-inset-bottom))] pt-2 backdrop-blur">
      <div className="mx-auto grid max-w-lg grid-cols-4">
        <BottomLink to="/mobile/home" label="ホーム" icon={HomeIcon} />
        <BottomLink to="/mobile/tasks" label="タスク" icon={TasksIcon} />
        <BottomLink to="/mobile/shifts" label="予定" icon={CalendarIcon} />
...
const menuItems = [
  ...
  ["実働報告", "/mobile/worklogs", ClockIcon],
  ["忘れ物", "/mobile/lost-items", BoxIcon],
] as const;
