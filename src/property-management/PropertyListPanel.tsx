      ...
      <div className="shrink-0 border-b border-slate-100 p-4">
        ...
        <div className="mt-4">
          <input
            ...
            onChange={(event) =>
              onPropertySearchChange(event.target.value)
            }
          ...
          {properties.map((property) => {
            ...
            return (
              <div
                ...
                className={[
                  "w-full cursor-pointer rounded-2xl border px-4 py-3 text-left transition focus:outline-none focus:ring-2 focus:ring-slate-300",
                  selected
                    ? "border-slate-900 bg-slate-900 text-white"
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {property.entrance_number ? (
                      <div
                        className={[
                          ...
                          selected ? "text-white/80" : "text-slate-700",
                        ].join(" ")}
                      >
                    ...
                    {property.google_maps_url ? (
                      <a
                        ...
                        className={[
                          "mt-2 inline-flex items-center rounded-full border px-3 py-1 text-xs font-bold underline-offset-2 hover:underline",
                          selected
                    ...
                    >
                      {roomCount} 室 / 最大対応可能 {property.max_assignable_count ?? "制限なし"} / 物件点数 {property.cleaning_point ?? 60}pt
                    </div>
                    ...
                    >
                      <span
                        className="inline-block h-3 w-5 rounded border border-slate-300"
